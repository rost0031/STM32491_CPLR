...
typedef enum DC3MsgName         DC3MsgName;
typedef enum DC3MsgType         DC3MsgType;
typedef enum DC3MsgRoute        DC3MsgRoute;
typedef enum DC3BootMode        DC3BootMode;
typedef enum DC3I2CDevices      DC3I2CDevices;
typedef enum DC3AccessType      DC3AccessType;

...
public:
    ...
    *
    * @param[in]   argc: number of command line arguments (same as main).
    * @param[in]   *argv[]: pointer to array of command line arguments (same as
    * (main)
    *
    * @return      None.
    */
   ClientApi( int argc, char** argv );
   ...
   /**
     ...
     * @return None:
     */
    const void setRedwoodMsgCallBack( cbRedwoodMsgHandler pCallbackFunction );
     ...
     * @return None:
     */
    const void setRedwoodAckCallBack( cbRedwoodMsgHandler pCallbackFunction );
     ...
     * @return None:
     */
    const void setInternalLogCallBack( cbRedwoodLogHandler pCallbackFunction );

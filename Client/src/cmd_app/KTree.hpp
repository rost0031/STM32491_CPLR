...
typedef enum MenuActions {
   ...
   MENU_SET_BOOT,
   MENU_DC3_EN_ETH_DBG,
   MENU_DC3_DIS_ETH_DBG,
   MENU_DC3_EN_SER_DBG,
   MENU_DC3_DIS_SER_DBG,
   MENU_DC3_GET_DBG_MODULES,
   MENU_DC3_EN_GEN_DBG_MODULE,
   MENU_DC3_DIS_GEN_DBG_MODULE,
   MENU_DC3_EN_SER_DBG_MODULE,
   MENU_DC3_DIS_SER_DBG_MODULE,
   MENU_DC3_EN_TIME_DBG_MODULE,
   MENU_DC3_DIS_TIME_DBG_MODULE,
   MENU_DC3_EN_ETH_DBG_MODULE,
   MENU_DC3_DIS_ETH_DBG_MODULE,
   MENU_DC3_EN_I2C_DBG_MODULE,
   MENU_DC3_DIS_I2C_DBG_MODULE,
   MENU_DC3_EN_I2C_DEV_DBG_MODULE,
   MENU_DC3_DIS_I2C_DEV_DBG_MODULE,
   MENU_DC3_EN_COMM_DBG_MODULE,
   MENU_DC3_DIS_COMM_DBG_MODULE,
   MENU_DC3_EN_CPLR_DBG_MODULE,
   MENU_DC3_DIS_CPLR_DBG_MODULE,
   MENU_DC3_EN_DB_DBG_MODULE,
   MENU_DC3_DIS_DB_DBG_MODULE,
   MENU_DC3_EN_FLASH_DBG_MODULE,
   MENU_DC3_DIS_FLASH_DBG_MODULE,
   MENU_DC3_EN_SYS_DBG_MODULE,
   MENU_DC3_DIS_SYS_DBG_MODULE,
   MENU_DC3_EN_NOR_DBG_MODULE,
   MENU_DC3_DIS_NOR_DBG_MODULE,
   MENU_DC3_EN_SDRAM_DBG_MODULE,
   MENU_DC3_DIS_SDRAM_DBG_MODULE,
   MENU_DC3_EN_DBGS_DBG_MODULE,
   MENU_DC3_DIS_DBGS_DBG_MODULE,

   MENU_DB_SAVE_DBG_DEV,
